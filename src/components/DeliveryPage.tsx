...
const PAYMENT_OPTIONS = [
  { 
    id: 'card', 
    label: 'Оплата банківською картою', 
    icon: CreditCard, 
  ...
  { 
    id: 'cod', 
    label: 'Оплата накладеним платежем та за реквізитами ФОП', 
    icon: Banknote, 
    content: 'Оплата при отриманні товару у відділенні Нової Пошти або кур\'єру (готівкою чи банківською картою). Також можлива оплата за реквізитами ФОП для фізичних та юридичних осіб.' 
  },
  { 
    id: 'compatibility', 
